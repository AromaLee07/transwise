...
async function microsoftTranslate(text, fromLang, toLang) {
  try {
    console.log("Microsoft translation");
    ...
    const response = await axios({
      method: 'post',
      url: TRANSLATION_SERVICES.microsoft.endpoint + '/translate',
      params: {
        'api-version': '3.0',
        'from': fromLang,
        'to': toLang
      ...
      headers: {
        'Ocp-Apim-Subscription-Key': TRANSLATION_SERVICES.microsoft.key,
        'Ocp-Apim-Subscription-Region': TRANSLATION_SERVICES.microsoft.region,
...
async function translateWithChatGPT(text, sourceLang, targetLang) {
  try {
    console.log("ChatGPT translation");
...
async function translateWithGoogle(text, sourceLang, targetLang) {
  try {
    ...
    console.log("From language:", sourceLang);
    console.log("To language:", targetLang);
    console.log("Text to translate:", text);
